                                ...
                                <div
                                    className={`w-10 h-10 flex items-center justify-center rounded-full text-sm font-semibold transition-all duration-300
                                     ${isCompleted
                                       ...
                                       `}
                                >
                                    {isCompleted ? <BiCheck size={16} /> : stepNumber}
                                </div>
                                <span
                ...
                <FormProvider {...methods}>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="flex 2xl:px-14 flex-col gap-4 sm:flex-row sm:justify-between mt-10">
                            ...
                            {
                                Step === 5 &&
                                <button type='submit' disabled={isLoading} className={`px-8 py-3 rounded-xl transition shadow-lg shadow-indigo-500/40  ${isLoading ? "bg-gray-500 cursor-not-allowed" : "bg-indigo-600 hover:bg-indigo-700"} `}>
                                    {isLoading ? (
