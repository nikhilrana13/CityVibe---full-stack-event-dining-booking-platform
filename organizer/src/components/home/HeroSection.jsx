  ...
  return (
     <section className="relative w-full min-h-[calc(100vh-75px)] flex items-center justify-center overflow-hidden pt-[75px] bg-gradient-to-br from-[#0f051d] via-[#1a0830] to-[#140424]">
                ...
                <div className="relative z-10 py-4 text-center px-4 max-w-5xl mx-auto">
                    ...
                    {/* CTA */}
                    <button onClick={()=>setIsLoginDialogOpen(true)} className="mt-10 px-10 py-4 rounded-2xl text-white font-semibold text-lg bg-gradient-to-r from-[#6a4dff] to-[#8b5cf6] hover:scale-105 hover:shadow-purple-500/50 transition-all duration-300 shadow-lg shadow-purple-600/30"> Get started </button>
