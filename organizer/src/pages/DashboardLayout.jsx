...
const DashboardLayout = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Organizer Dashboard | CityVibe</title>
        <meta name="description" content="Manage your events and restaurant listings on CityVibe organizer dashboard." />
      ...
      <div className="w-full">
        ...
        <header className="fixed top-0 left-0 right-0 justify-between bg-white border-b z-[9999] min-h-[75px] flex items-center px-4">
          ...
          <BiMenu onClick={() => setIsOpen(true)} className='block lg:hidden cursor-pointer' />
        </header>
