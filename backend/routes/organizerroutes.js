...
const {OnBoardingOrganizer, UpdateBusinessProfile, OrganizerDashboardStats, EventManagementStats, ManageDiningStats, EventBookingPageStats, DiningBookingPageStats, OrganizerProfile, OrganizerRevenueAnalytics} = require("../controllers/organizercontroller.js")
...
router.get("/analytics/revenue",AuthMiddleware,OrganizerAuth,OrganizerRevenueAnalytics)
