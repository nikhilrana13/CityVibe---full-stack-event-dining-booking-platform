...
import { formatIndianNumber, formatTime } from '@/lib/utils';
...
const getNext17Days = () => {
    ...
    for (let i = 0; i < 17; i++) {
        ...
        if (i === 0) {
            dates.push(`Today, ${dayNum} ${month}`)
        } else if (i === 1) {
            dates.push(`Tomorrow, ${dayNum} ${month}`)
        } else {
                    ...
                    <div className='border space-y-4 py-6 px-7 w-full rounded-xl sticky top-24 bg-white shadow-sm'>
                        ...
                        <div className='flex gap-3'>
                            ...
                            <div className='flex flex-col w-full gap-2'>
                                ...
                                <select className='border font-[500] rounded-md px-3 py-3'>
                                    {guestscount.map((g) => (
                                        <option key={g}>
                                            {g} {g === 1 ? "Guest" : "Guests"}
                                        </option>
                        ...
                        <button className='px-3 py-3 bg-black font-[500] text-white w-full rounded-md hover:bg-gray-900 transition'>
                            Book a table
                        </button>
                    </div>
                </div>
