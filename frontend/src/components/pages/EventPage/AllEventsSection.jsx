...
const AllEventsSection = ({ initialLoading,isFetchingMore, pagination, allevents, location, loaderRef, category }) => {
    ...
    return (
        <div className='mx-auto px-4 gap-4 py-4 max-w-[1300px]'>
            ...
            {!initialLoading && allevents.length > 0 && pagination?.currentPage < pagination?.totalPages && (
