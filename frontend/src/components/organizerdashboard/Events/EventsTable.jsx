                            ...
                            >
                                ...
                                <div className="p-4 flex flex-col gap-3">
                                    ...
                                    <div className="flex gap-3">
                                        <button className="flex-1 py-2 rounded-xl border text-sm hover:bg-gray-50 transition">
                                            View
                                        </button>
                                        <button className="flex-1 py-2 rounded-xl bg-black text-white text-sm hover:opacity-90 transition">
                                            Edit
                                        </button>
                                    </div>
                                </div>
        ...
        <div className="relative group inline-block text-left">
            ...
            <div className="absolute right-0 mt-2 w-40 bg-white border rounded-xl shadow-lg opacity-0 invisible group-hover:visible group-hover:opacity-100 transition-all duration-200 z-50">
                <div className="flex flex-col text-sm">
                    <button className="px-4 py-2 hover:bg-gray-50 text-left">Edit</button>
                    <button className="px-4 py-2 hover:bg-red-50 text-red-600 text-left">
                        Delete
                    </button>
                </div>
            </div>
