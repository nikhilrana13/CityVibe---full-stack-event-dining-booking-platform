...
const ScanSection = () => {
    ...
    const handleVerifyTicket = async (codeFromScan) => {
        ...
        try {
            setloading(true)
            const response = await axios.put(`${import.meta.env.VITE_BACKEND_URL}/api/event/verify-ticket`, { ticketCode: code }, {
                headers: {
    ...
    return (
        ...
        <div className="grid lg:grid-cols-2 gap-8 mt-6">
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-6 flex flex-col gap-6">
                ...
                />
                <button disabled={loading} onClick={() => handleVerifyTicket()} className="bg-gray-900 hover:bg-black transition text-white py-3 rounded-xl font-medium shadow-md">
                    {loading ? <Loader2 className='w-5 h-5 animate-spin mx-auto' /> : "Verify Ticket"}
                </button>
