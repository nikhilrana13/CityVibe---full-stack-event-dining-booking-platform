import { FileCheck2, Loader2, UploadCloudIcon } from 'lucide-react'
    ...
    return (
        <div className='grid grid-cols-1 gap-5 md:grid-cols-2'>
            <div className='flex flex-col gap-1'>
                ...
                <input type='text' className='border px-3 py-5 w-full outline-none  rounded-xl placeholder:text-sm' placeholder='ABCDEF1234F' {...register("panNumber", {
            ...
            <div className='flex flex-col gap-1'>
                ...
                <label htmlFor='pancardimage' className='flex items-center gap-3 min-h-[65px] border rounded-xl px-4 py-3 cursor-pointer hover:bg-gray-50 transition'>
                    {uploading ? (
                        ...
                        <div className="flex items-center gap-3">
                            <FileCheck2 className="text-gray-600" size={22} />
                        ...
                        <div className="flex items-center gap-3">
                            <UploadCloudIcon className="text-gray-600"  size={22} />
